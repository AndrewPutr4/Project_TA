    ...
    public function run(): void
    {
        ...
        DB::table('menus')->insert([
            ...
            [
                'id' => 5,
                'name' => 'Bakso Malang',
                'description' => 'Bakso khas Malang dengan tahu dan siomay',
                'price' => 16000,
                'image' => null,
                'category_id' => 1,
                'is_available' => true,
            ...
            [
                'id' => 6,
                'name' => 'Bakso Bakar',
                'description' => 'Bakso bakar dengan bumbu kecap manis',
                'price' => 14000,
                'image' => null,
                'category_id' => 1,
                'is_available' => true,
            ...
            [
                'id' => 7,
                'name' => 'Bakso Goreng',
                'description' => 'Bakso goreng crispy dengan saus sambal',
                'price' => 13000,
                'image' => null,
                'category_id' => 1,
                'is_available' => true,
            ...
            [
                'id' => 8,
                'name' => 'Bakso Pedas',
                'description' => 'Bakso dengan kuah pedas dan cabai rawit',
                'price' => 15000,
                'image' => null,
                'category_id' => 1,
                'is_available' => true,
